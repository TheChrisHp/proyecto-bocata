    ...
    return(
        ...
        <div className="cont-encabezado-ganadores">
            ...
            <path fill="#c90000" fill-opacity="1" d="M0,64L120,58.7C240,53,480,43,720,64C960,85,1200,139,1320,165.3L1440,192L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path>
                ...
                <img className="g-icon d-md img-fluid" src="./resources/ganador-icon.png" alt="ganador-icon" />
                <h1 className="h1">¡GANADORES  DE <span style={{background:'red', color:'white'}}>SORTEOS!</span></h1>
                <img className="g-icon2 img-fluid" src="./resources/ganador-icon.png" alt="ganador-icon" />
            </div>
            <section className="s-sorteos d-flex flex-wrap">
                ...
                <img className="img-fluid" src="./resources/draw-7.svg" alt="draw-7" />
            </section>
        ...
        <div className="botones-ganadores">
            ...
            <button onClick={() =>{ mostrarImg('https://res.cloudinary.com/dfnton7oq/image/upload/v1714844115/samples/bocata-imgs/ganador-sorteo-1_n4pgwt.png', 'primero')}} className={`btn-ganadores-img ${botonActivo === 'primero' ? 'activo' : ''}`}>FEB/MAR 2024 {botonActivo === 'primero' && <img src='./resources/flecha-img.png' className='flecha'/>}</button>

            <button onClick={() =>{ mostrarImg('https://res.cloudinary.com/dfnton7oq/image/upload/v1714844155/samples/bocata-imgs/mes-3-1_nfzorw.png', 'segundo')}} className={`btn-ganadores-img ${botonActivo === 'segundo' ? 'activo' : ''}`}>DIC 2023 - ENE 2024 {botonActivo === 'segundo' && <img src='./resources/flecha-img.png' className='flecha'/>}</button>

            <button onClick={() =>{ mostrarImg('https://res.cloudinary.com/dfnton7oq/image/upload/v1714844223/samples/bocata-imgs/mes-1-1_qclsdq.png', 'tercero')}} className={`btn-ganadores-img ${botonActivo === 'tercero' ? 'activo' : ''}`}>OCT - NOV 2023 {botonActivo === 'tercero' && <img src='./resources/flecha-img.png' className='flecha'/>}</button>

            <button onClick={() => {mostrarImg('https://res.cloudinary.com/dfnton7oq/image/upload/v1714844224/samples/bocata-imgs/mes-2-1_kuccug.png', 'cuarto')}} className={`btn-ganadores-img ${botonActivo === 'cuarto' ? 'activo' : ''}`}>AGO - SET 2023 {botonActivo === 'cuarto' && <img src='./resources/flecha-img.png' className='flecha'/>}</button>
            </div>
