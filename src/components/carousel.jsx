...
export default function Demo() {
  ...
  return (
    ...
    >
      ...
      <Carousel.Slide> <img src="https://res.cloudinary.com/dfnton7oq/image/upload/v1714697188/samples/bocata-imgs/img42_c9vsji.jpg" alt="" style={{ width: '100%', height: 'auto', objectFit: 'cover'}} /> </Carousel.Slide>
      </Carousel>
  );
}